...
{1: 'CNAM', 4: 1686693600, 6: 1631203329, -260: {1: {'v': [{'ci': 'URN:UVCI:01:FR:5OKUVPVTUFLU#L', 'co': 'FR', 'dn': 2, 'dt': '2021-09-09', 'is': 'CNAM', 'ma': 'ORG-100030215', 'mp': 'EU/1/20/1528', 'sd': 2, 'tg': '840539006', 'vp': 'J07BX03'}], 'dob': '2002-02-10', 'nam': {'fn': 'ARQUE--FERRADOU', 'gn': 'CLERY', 'fnt': 'ARQUE<<FERRADOU', 'gnt': 'CLERY'}, 'ver': '1.3.0'}}, 'kid': 'fGLuvg6n5wk='}

COMMENT T'ES TROP BEAU JE SAIS MAIS JE M'EN BAS LES COUILLES FRÉROT
